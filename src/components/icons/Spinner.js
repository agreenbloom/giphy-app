...
<svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} xmlns="http://www.w3.org/2000/svg">
  <circle cx="50" cy="50" fill="none" strokeLinecap="round" r={radius} strokeWidth={strokeWidth} stroke={stroke} strokeDasharray="62.83185307179586 62.83185307179586" transform="rotate(1.99877 50 50)">
